...
import { Panel, String, MPPT, Appliance, Location, Inverter, Charger } from './types';
...
interface State {
  ...
  setDrivingHoursPerDay: (hours: number) => void;
  setAuth: (isAuthenticated: boolean, user: { email: string } | null) => void;
  logout: () => void;
}
...
export const useStore = create<State>((set) => ({
  ...
  setDrivingHoursPerDay: (hours) => set({ drivingHoursPerDay: hours }),
